...
exports.registrationUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (isEmailExist) {
            return next(new ErrorHandler_1.default("E-mail dejà existant", 400));
        }
        const user = {
            name,
            email,
        ...
        try {
            ...
            res.status(201).json({
                success: true,
                message: `Veuillez verifier votre boite mail: ${user.email} afin d'activer votre compte !`,
...
exports.activateUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (newUser.activationCode !== activation_code) {
            return next(new ErrorHandler_1.default("Code d'activation invalide", 400));
        }
...
exports.loginUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    ...
    try {
        ...
        if (!email || !password) {
            return next(new ErrorHandler_1.default("Veuillez entrez votre e-mail et mot de passe ", 400));
        }
        const user = await user_model_1.default.findOne({ email }).select("+password");
        if (!user) {
            return next(new ErrorHandler_1.default("Mot de passe ou email invalide", 400));
        }
...
exports.updatePassword = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!oldPassword || !newPassword) {
            return next(new ErrorHandler_1.default("Veuillez entrez l'ancien et le nouveau mot de passe", 400));
        }
        ...
        if (!isPasswordMatch) {
            return next(new ErrorHandler_1.default("Ancien mot de passe incorrect", 400));
        }
...
exports.deleteUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!user) {
            return next(new ErrorHandler_1.default("Utilisateur non trouvé", 404));
        }
